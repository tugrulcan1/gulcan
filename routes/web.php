...
use App\Http\Controllers\BolmeController;
...
Route::group(['prefix' => 'admin', "as" => "admin.", 'middleware' => ['admin']], function () {
    ...
    Route::delete('/rafs/{raf}', [RafController::class, 'destroy'])->name('rafs.destroy');

    Route::get('/rafs/create', [RafController::class, 'create'])->name('rafs.create');
    Route::post('/rafs', [RafController::class, 'store'])->name('rafs.store');

    Route::get('/rafs/{raf}/edit', [RafController::class, 'edit'])->name('rafs.edit');

    Route::put('/rafs/{raf}', [RafController::class, 'update'])->name('rafs.update');

    Route::get('/rafs', [RafController::class, 'index'])->name('rafs.index');

    //////////////////////////////////////////////////////////////////

    Route::delete('/sutuns/{sutun}', [SutunController::class, 'destroy'])->name('sutuns.destroy');

    Route::get('/sutuns/create', [SutunController::class, 'create'])->name('sutuns.create');
    Route::post('/sutuns', [SutunController::class, 'store'])->name('sutuns.store');

    Route::get('/sutuns/{sutun}/edit', [SutunController::class, 'edit'])->name('sutuns.edit');
    ...
    Route::delete('/bolmes/{bolme}', [BolmeController::class, 'destroy'])->name('bolmes.destroy');

    Route::get('/bolmes/create', [BolmeController::class, 'create'])->name('bolmes.create');
    Route::post('/bolmes', [BolmeController::class, 'store'])->name('bolmes.store');

    Route::get('/bolmes/{bolme}/edit', [BolmeController::class, 'edit'])->name('bolmes.edit');

    Route::put('/bolmes/{bolme}', [BolmeController::class, 'update'])->name('bolmes.update');

    Route::get('/bolmes', [BolmeController::class, 'index'])->name('bolmes.index');

    Route::get('/get-sutuns/{rafID}', [BolmeController::class, 'getSutunstoRaf'])->name('getSutunsToRaf');
    Route::get('/get-bolmes/{sutunID}', [BolmeController::class, 'getBolmesToSutun'])->name('getBolmesToSutun');
