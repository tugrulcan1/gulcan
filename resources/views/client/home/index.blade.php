                ...
                <div class="slide">
                    ...
                    <div class="auto-container">
                        <div class="content">
                            ...
                            <div class="text">
                                <p>Duty obligations of business will frequently occur pleasures<br> be repudiated and
                ...
                <div class="col-xl-6">
                    <div class="contact-form-box1">
                        ...
                        <form action="{{ route('orders.store') }}" method="post">
                            ...
                            @endif
                            <div class="input-box">
                                <input type="text" name="company_name" value="" placeholder="İşletme Adı"
                                    required="">
                                <div class="icon">
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-box">
                                    <input type="text" name="qt" value="" placeholder="Adet (Koli)"
                                        required="">
                                    <div class="icon">
