            ...
            <div class="card shadow-none border border-300  p-0" data-component-card="data-component-card">
                <div class="card-header border-bottom border-300 bg-soft">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-900 mb-0" data-anchor="data-anchor" id="soft-buttons">Create bolme</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="p-4 code-to-copy">
                        <form action="{{ route('admin.bolmes.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="title">Bölme İsim</label>
                                <input class="form-control" id="name" name="name" type="text"
                                    placeholder="bolme Başlık">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="name" name="product_number" type="text"
                                    placeholder="bolme Başlık">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="title">Bölme Sütun İd</label>
                                <input class="form-control" id="name" name="sutun_id" type="text"
                                    placeholder="bolme Başlık">
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary">Create bolme</button>
