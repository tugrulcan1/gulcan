        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="projectSummary"
                    data-list='{"valueNames":["projectName","assigness","start","deadline","task","projectprogress","status","action"],"urun":12,"pagination":true}'>
                    <div class="row justify-content-between mb-4 gx-6 gy-3 align-items-center">
                        <div class="col-auto">
                            <h2 class="mb-0">Sayfalar<span class="fw-normal text-700 ms-3">({{ count($uruns) }})</span>
                            </h2>
                        </div>
                        <div class="col-auto">
                            <div class="col-auto">
                                <a class="btn btn-primary px-5" href="{{ route('admin.uruns.create') }}">
                    ...
                    <div class="card shadow-none border border-300 my-4 p-5">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="projectName" style="width:20%;">Ürün İsim</th>
                                            <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                        ...
                                        <tr class="position-static">
                                            ...
                                            <td>
                                                @if (in_array('GetUrunById', $userPermissions) && in_array('UpdateUrun', $userPermissions))
                                                    <a href="{{ route('admin.uruns.edit', $urun->id) }}"
                                                        class="btn btn-sm btn-primary">Güncelle</a>
                                                @elseif (in_array('GetUrunById', $userPermissions))
                                                    <a href="{{ route('admin.uruns.edit', $urun->id) }}"
                                                        class="btn btn-sm btn-primary">Önizle</a>
                                                @endif
                                                @if (in_array('DeleteUrun', $userPermissions))
                                                    <!-- Silme işlemi için modal -->
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal{{ $urun->id }}">
                                                        Sil
                                                    </button>
                                                @endif
                                                ...
                                                <!-- Silme işlemi için modal -->
                                                <div class="modal fade" id="deleteModal{{ $urun->id }}" tabindex="-1"
                                                    aria-labelledby="deleteModalLabel{{ $urun->id }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="deleteModalLabel{{ $urun->id }}">Sil
                                                                </h5>
                                                                <button type="button" class="btn p-1"
                                                                    data-bs-dismiss="modal" aria-label="Close">
                                                                    <svg class="svg-inline--fa fa-xmark fs--1"
                                                                        aria-hidden="true" focusable="false"
                                                                        data-prefix="fas" data-icon="xmark" urun="img"
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('admin.uruns.destroy', $urun->id) }}"
                        ...
                        <div
                            ...
                            <div class="d-flex"><button class="urun-link" data-list-pagination="prev"><span
                                        class="fas fa-chevron-left"></span></button>
                                <ul class="mb-0 pagination"></ul><button class="urun-link pe-0"
